...
func main() {
	...
	width:= art_justify.GetTerminalWidth()
	art_text := art_justify.AsciiArt(text, banner)

	// art_justify.LeftAlign(art_text)
	//art_justify.RightAlign(art_text, width)
	//art_justify.CenterAlign(art_text, width)
	art_justify.JustifyAlign(art_text, text, width, banner)
	fmt.Println(width)
